        ...
        },
        {
            ...
            effect: () => {
                ...
                m.hold = function () {
                    ...
                    m.fieldRange = 900 + 900 * wave + 900 * tech.isBigField
                    m.fieldArc = 900 + 900 * wave + 900 * tech.isBigField //run calculateFieldThreshold after setting fieldArc, used for powerUp grab and mobPush with lookingAt(mob)
